...
class DemoHomePage(WebDriverSetup):
    ...
    def test_Input_Form(self):
        ...
        self.assertEqual(driver.find_element(*home.DEMO_FORM_FIRST_NAME).get_attribute("value"), "Bob", f'Got {driver.find_element(*home.DEMO_FORM_FIRST_NAME).get_attribute("value")}')
