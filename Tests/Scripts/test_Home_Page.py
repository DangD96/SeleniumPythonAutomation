...
class DemoHomePage(WebDriverSetup):
    ...
    def test_Input_Form(self):
        ...
        first_name_field = driver.find_element(*home.DEMO_FORM_FIRST_NAME)
        self.assertEqual(first_name_field.get_attribute("value"), "Bob", f'Expected: Bob. Got: {first_name_field.get_attribute("value")}')
